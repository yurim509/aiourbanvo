...
//cancel 정상동작 확인완료
export const cancelStudy = async (checkedReservationId) => {
    const config = getConfig();
...
// export const getUserStudyById = async ({ uno, page, size }) => {
//     console.log("Fetching user study by ID:dsfsadfasdfsafsaf", uno, page, size);
...
// export const modifyStudy = async (reservationId, reservationData) => {
